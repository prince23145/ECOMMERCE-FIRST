      ...
      const mockOrders = [
        {
          _id: 1234456,
          createdat: new Date(),
          shippingAdderess: { city: "delhi", country: "india" },
          orderItems: [
            {
              name: "Product 1",
              ...
              orders.map((order) => (
                ...
                >
                  ...
                  <td className="py-2 px-2 sm:py-4 sm:px-4 ">
                   ...
                   <td className="py-2 px-2 sm:px-4 sm:py-4">
                    {order.shippingAdderess? `${order.shippingAdderess.city},${order.shippingAdderess.country}`:"N\A"}
                   </td>
                    <td className="py-2 px-2 sm:px-4 sm:py-4">
                     ...
                     <td className="py-2 px-2 sm:px-4 sm:py-4">
                      ...
                      <td className="py-2 px-2 sm:px-4 sm:py-4">
                        ...
                        text-xs sm:text-sm font-medium` }>{order.isPaid?"Paid":"Pendinng"}</span>
                      </td>
