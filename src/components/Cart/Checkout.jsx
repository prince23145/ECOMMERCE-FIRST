    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6 tracking-tight">
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <form onSubmit={handelCreateCheckout}>
          <h3 className="text-lg mb-4">Conatact Details</h3>
          <div className="mb-4">
          ...
          <div className="mt-6">
              {!checkoutId?(
                ...
                <div>
                  ...
                  {/* paypal component */}
                  <PaypalButton amount={"100"} onSuccess={handelPaymentSuccess} onError={(err)=>alert("Payment Failed. Try again. ")}/>
                </div>
              )}
          </div>
        </form>
    ...
    {cart.products.map((products,index)=>(
      <div key={index} className="flex items-start justify-between py-2 border-b">
        <div className="flex items-start">
          ...
          <p className="text-xl"> ${products.price.toString()}</p>
      </div>
    ))}
  </div>
