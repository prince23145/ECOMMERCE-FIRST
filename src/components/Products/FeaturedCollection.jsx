...
export default function FeaturedCollection() {
  return (
    <section className="py-16 px-4 lg:px-7 mx-auto">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl ">
        ...
        <div className="lg:w-1/2 p-8 text-center lg:text-left">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            Apparel made fpr your everyday life
          </h2>
          <p className="text-lg text-gray-600 mb-6">
            Discover high quality , comfortable clothing that effortlessly blends fashion and function. Desinged to make you laugh and feel great every day.
          </p>
