...
export default function Hero() {
  return (
    <section className='relative'>
        <img src={heroImg} alt="Rabbit" className=' w-full h-[400px] md:h-[750px] object-cover' />
        <div className='absolute inset-0   bg-opacity-5 flex items-center justify-center'>
            <div className='text-center text-white p-6'>
                ...
                <Link to="#" className='bg-white text-gray-950 px-6 py-2 rounded-2xl text-lg'> Shop Now </Link>
            </div>
        </div>
    </section>
  )
